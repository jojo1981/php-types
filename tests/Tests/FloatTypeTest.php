...
final class FloatTypeTest extends TestCase
{
    ...
    {
        self::assertSame('float', $this->type->getName());
    }
    ...
    {
        self::assertTrue($this->type->isNumber());
        self::assertInstanceOf(AbstractNumberType::class, $this->type);
    }
    ...
    public function testIsOfCertainType(): void
    {
        ...
        self::assertTrue($this->type->isFloat());
    ...
    public function testIsEqual(): void
    {
        ...
        self::assertTrue($this->type->isEqual(new FloatType()));
