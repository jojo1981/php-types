...
class MixedTypeTest extends TestCase
{
    ...
    {
        $this->assertSame('mixed', $this->type->getName());
    }
    ...
    public function testIsEqual(): void
    {
        ...
        $this->assertTrue($this->type->isEqual(new MixedType()));
    ...
    public function testIsAssignableType(): void
    {
        ...
        $this->assertTrue($this->type->isAssignableType(new ArrayType()));
        $this->assertTrue($this->type->isAssignableType(new BooleanType()));
        $this->assertTrue($this->type->isAssignableType(new CallableType()));
        $this->assertTrue($this->type->isAssignableType(new ClassType(new ClassName(__CLASS__))));
        $this->assertTrue($this->type->isAssignableType(new FloatType()));
        $this->assertTrue($this->type->isAssignableType(new IntegerType()));
        $this->assertTrue($this->type->isAssignableType(new IterableType()));
        $this->assertTrue($this->type->isAssignableType(new MixedType()));
        $this->assertTrue($this->type->isAssignableType(new MultiType([new NullType(), new StringType()])));
        $this->assertTrue($this->type->isAssignableType(new NullType()));
        $this->assertTrue($this->type->isAssignableType(new ObjectType()));
        $this->assertTrue($this->type->isAssignableType(new ResourceType()));
        $this->assertTrue($this->type->isAssignableType(new StringType()));
    ...
    {
        $this->assertTrue($this->type->isAssignableValue([]));
        $this->assertTrue($this->type->isAssignableValue(['item1', 'item2', 'item3']));
        $this->assertTrue($this->type->isAssignableValue(['key1' => 'item1', 'key2' => 'item2', 'key3' => 'item3']));
        $this->assertTrue($this->type->isAssignableValue(true));
        $this->assertTrue($this->type->isAssignableValue(false));
        $this->assertTrue($this->type->isAssignableValue(static function () {}));
        $this->assertTrue($this->type->isAssignableValue(new TestEntity()));
        $this->assertTrue($this->type->isAssignableValue(new \stdClass()));
        $this->assertTrue($this->type->isAssignableValue(-1.0));
        $this->assertTrue($this->type->isAssignableValue(0.0));
        $this->assertTrue($this->type->isAssignableValue(1.0));
        ...
        $this->assertTrue($this->type->isAssignableValue(\fopen(__FILE__, 'rb')));
        $this->assertTrue($this->type->isAssignableValue(''));
        $this->assertTrue($this->type->isAssignableValue('text'));
    }
}