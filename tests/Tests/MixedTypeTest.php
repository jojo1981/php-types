...
final class MixedTypeTest extends TestCase
{
    ...
    {
        self::assertSame('mixed', $this->type->getName());
    }
    ...
    public function testIsEqual(): void
    {
        ...
        self::assertTrue($this->type->isEqual(new MixedType()));
    ...
    public function testIsAssignableType(): void
    {
        ...
        self::assertTrue($this->type->isAssignableType(new BooleanType()));
        self::assertTrue($this->type->isAssignableType(new CallableType()));
        self::assertTrue($this->type->isAssignableType(new ClassType(new ClassName(__CLASS__))));
        self::assertTrue($this->type->isAssignableType(new FloatType()));
        self::assertTrue($this->type->isAssignableType(new IntegerType()));
        self::assertTrue($this->type->isAssignableType(new IterableType()));
        self::assertTrue($this->type->isAssignableType(new MixedType()));
        self::assertTrue($this->type->isAssignableType(new MultiType([new NullType(), new StringType()])));
        self::assertTrue($this->type->isAssignableType(new NullType()));
        self::assertTrue($this->type->isAssignableType(new ObjectType()));
        self::assertTrue($this->type->isAssignableType(new ResourceType()));
    ...
    public function testIsAssignableValue(): void
    {
        ...
        self::assertTrue($this->type->isAssignableValue(true));
        self::assertTrue($this->type->isAssignableValue(false));
        self::assertTrue($this->type->isAssignableValue(static function () {}));
        self::assertTrue($this->type->isAssignableValue(new TestEntity()));
        self::assertTrue($this->type->isAssignableValue(new stdClass()));
        self::assertTrue($this->type->isAssignableValue(-1.0));
        self::assertTrue($this->type->isAssignableValue(0.0));
        self::assertTrue($this->type->isAssignableValue(1.0));
        ...
        self::assertTrue($this->type->isAssignableValue(fopen(__FILE__, 'rb')));
        self::assertTrue($this->type->isAssignableValue(''));
