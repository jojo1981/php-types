...
final class VoidTypeTest extends TestCase
{
    ...
    {
        self::assertSame('void', $this->type->getName());
    }
    ...
    public function testIsOfCertainType(): void
    {
        ...
        self::assertTrue($this->type->isVoid());
    }
    ...
    public function testIsEqual(): void
    {
        ...
        self::assertTrue($this->type->isEqual(new VoidType()));
    ...
    public function testIsAssignableType(): void
    {
        ...
        self::assertTrue($this->type->isAssignableType(new VoidType()));
